    ...
    <>
      <div className='bg-neutral-100 w-99vw'> 
        ...
        <div className='flex justify-center'>
            <Card img={plankton} desc="A interactive game developed in a group of 5 for the NASA Space Apps Challenge in order to educate others on phytoplankton." langs={["JavaScript","HTML", "CSS", "React"]}/>
